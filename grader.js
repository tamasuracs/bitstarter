...
var checkHtmlFileOrUrl = function(htmlfile, url, checksfile) {
...
if(require.main == module) {
	...
	.option('-u, --url <html_url>', 'URL to index.html', clone(assertURLExists), null)
        .parse(process.argv);
    checkHtmlFileOrUrl(program.file, program.url, program.checks);
